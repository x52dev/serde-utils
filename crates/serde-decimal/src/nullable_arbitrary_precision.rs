//! Serialization and deserialization of required but nullable decimals with arbitrary precision.
...
/// Nullable arbitrary-precision decimal deserializer.
///
...
/// Nullable arbitrary-precision decimal serializer.
///
/// See [module docs](self) for more.
...
mod tests {
    ...
    struct Foo {
        #[serde(with = "crate::nullable_arbitrary_precision")]
